...
import {Text, View, Alert, TouchableOpacity, TextInput, TouchableWithoutFeedback, Keyboard} from 'react-native'
...
function BuckForm() {
  ...
  const submit = () =>{
    if(name == "" || type == "" || cageNo == "" || description == "")
    {
        ...
        .then((response) =>{
            if(response.data.message == "Buck Name Already Exist"){
                Alert.alert("Error", "Buck Name Already Exist") 
            }
            else{
                Alert.alert("Success", "Buck Added");
                setname('');
                settype('');
                setcageNo('');
                setdescription('');
    ...
    return (
        ...
        <View style={styles.form}>
            <View style={styles.header}><Text style={styles.title}>Add Buck</Text></View>
            <View style={styles.formBody}>
                ...
                <View style={styles.control}>
                    ...
                    <TextInput style={styles.input} 
                    placeholder='Enter buck description'
                    placeholderTextColor= 'white'
                    value={description}
